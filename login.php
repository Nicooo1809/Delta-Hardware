						...
						<div class="col-lg-10 col-xl-7 mx-auto">
							...
							<form action="login.php" method="post">
								<div class="form-floating mb-3">
									<input id="inputEmail" type="email" name="email" placeholder="E-Mail" value="<?php echo $email_value; ?>" autofocus class="form-control is-invalid border-0 shadow-sm ps-4 text-dark fw-bold" required>
									<label for="inputEmail" class="text-dark fw-bold">E-Mail</label>
									<label for="inputEmail">E-Mail-Adresse muss ausgefüllt sein</label>
								</div>
								<div class="form-floating mb-3">
                                    <input id="inputPassword" type="password" name="passwort" placeholder="Passwort" class="form-control is-invalid border-0 shadow-sm ps-4 text-dark fw-bold" required>
