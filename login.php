						...
						<div class="col-lg-10 col-xl-7 mx-auto">
							...
							<form action="login.php" method="post" class="form-floating">
								<div class="form-group mb-3">
									<input id="floatingInput" type="email" name="email" placeholder="E-Mail" value="<?php echo $email_value; ?>" autofocus class="form-control border-0 shadow-sm px-4 text-dark fw-bold" required>
								</div>
								<div class="form-group mb-3">
