...
<!-- Desktop Devices -->
<div class="container-fluid minheight100 my-3 py-3 px-3">
    <div class="row no-gutter">
        <div class="col">
            <div class="card bg-dark mx-auto" style="width: 50rem;">
                <div class="card-body">
                    <h1 class="card-title my-0 text-center">Wer sind wir?</h1>
