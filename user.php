...
if(isset($_POST['action'])) {
    ...
    if($_POST['action'] == 'mod') {
        ...
        error_log('1');
        error_log(isset($_POST['vorname']) and isset($_POST['nachname']) and isset($_POST['email']) and isset($_POST['passwortNeu']) and isset($_POST['passwortNeu2']) and !empty($_POST['vorname']) and !empty($_POST['nachname']) and !empty($_POST['email']) and !empty($_POST['passwortNeu']) and !empty($_POST['passwortNeu2']));
