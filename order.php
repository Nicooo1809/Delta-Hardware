                        ...
                        <tbody>
                            <?php foreach ($products as $product): ?>
                                <tr>
                                    ...
                                    <button type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="<span><?=($product['maxquantity'] < $product['quantity'] ? '<svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Warning:"><use xlink:href="#exclamation-triangle-fill"/></svg>' : "")?></span>">
                                        Tooltip on top
                                    </button>
                                    </td>
                                </tr>
