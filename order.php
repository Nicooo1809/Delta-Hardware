                            ...
                            <?php foreach ($products as $product): ?>
                                <tr>
                                    ...
                                    <td class="border-0 align-middle text-center ctext" style="width: 10%;">
                                        <span><?=($product['maxquantity'] < $product['quantity'] ? '<svg title="TEST" class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Warning:"><use xlink:href="#exclamation-triangle-fill"/></svg>' : "")?></span>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
