...
if(!isMobile()):
?>
    <footer contentEditable class="container-fluid fixed-bottom footer py-3 bg-dark">
        <div class="">
...
<?php else:?>
    <footer contentEditable class="container-fluid fixed-bottom footer py-1 bg-dark">
        <div class="">
