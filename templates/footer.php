...
if(!isMobile()):
?>
    <footer contentEditable class="container-fluid position-absolute bottom-0 footer py-3 bg-dark">
        <div class="">
...
<?php else:?>
    <footer contentEditable class="container-fluid position-absolute bottom-0 footer py-1 bg-dark">
        <div class="">
